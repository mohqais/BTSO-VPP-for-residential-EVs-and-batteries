...
The VPP is optimally scheduled using a novel Binary Transient Search Optimization (Binary TSO) algorithm, which is benchmarked against five established metaheuristics: Binary PSO, Grey Wolf Optimizer (GWO), Genetic Algorithm (GA), Differential Evolution (DE), and others.
